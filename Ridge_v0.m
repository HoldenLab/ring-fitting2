...
%Input image
img = imread('.\testing\testKymographs\SM1_JF-549_500ms.exp_50.Power_100x6s_3_MMStack_Pos0.ome_denoise_reg_ring15_kymoWrap.tif');
%Show input image
figure, imagesc(img);
img = double (img);
...
blurSigma=2;
[ridge valley gxx, gyy ] = ridgefilter(img,blurSigma);
Filtered_X=-gxx;
Filtered_Y=-gyy;
