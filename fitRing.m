...
%   'FixedPositionFit', fitParAvg: Fix the ring position to the average ring position.  FITPARAVG is the result of a prior fit to an averaged ring, used to fix the positions. DEFAULT: false 
